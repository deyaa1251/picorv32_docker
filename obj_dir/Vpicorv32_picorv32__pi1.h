...
class alignas(VL_CACHE_LINE_BYTES) Vpicorv32_picorv32__pi1 final {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ pcpi_valid;
        CData/*0:0*/ pcpi_wr;
        CData/*0:0*/ pcpi_wait;
        CData/*0:0*/ pcpi_ready;
    ...
    ~Vpicorv32_picorv32__pi1();
    void ctor(Vpicorv32__Syms* symsp, const char* namep);
    void dtor();
