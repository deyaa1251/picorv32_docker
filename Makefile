...
RISCV_GNU_TOOLCHAIN_INSTALL_PREFIX = /opt/xpack-riscv-none-elf-gcc-14.2.0-3
...
FIRMWARE_OBJS = firmware/start.o firmware/irq.o firmware/print.o firmware/hello.o firmware/sieve.o firmware/multest.o firmware/stats.o firmware/game.o
